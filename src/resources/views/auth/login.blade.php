                                ...
                                <div class="p-sm-3 px-lg-4 py-lg-5">
                                    ...
                                    <form class="js-validation-signin" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="py-3">
                                            ...
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-alt form-control-lg @error('password') is-invalid @enderror" value="{{ old('password') }}" id="password" name="password" placeholder="Password" required autocomplete="password" autofocus>
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label font-w400" for="remember">Se rappeler de moi ?</label>
                                                </div>
                                            </div>
                                        </div>
