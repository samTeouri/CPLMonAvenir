            ...
            <ul class="nav-main">
                ...
                <li class="nav-main-item">
                    <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        ...
                        <span class="nav-main-link-name">Elèves</span>
                    </a>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            {{-- <a class="nav-main-link" href="{{ route('eleves.create') }}">
                                <span class="nav-main-link-name">Inscrire un élève</span>
                            </a> --}}
                        </li>
                        <li class="nav-main-item">
                            {{-- <a class="nav-main-link" href="{{ route('eleves.index') }}">
                ...
                <li class="nav-main-item open">
                    ...
                    <ul class="nav-main-submenu">
                        ...
                        <li class="nav-main-item open">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link active" href="be_layout_sidebar_mini.html">
