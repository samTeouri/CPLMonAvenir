            ...
            <div>
                ...
                <div class="js-wizard-simple block block">
                    ...
                    <ul class="nav nav-tabs nav-tabs-alt nav-justified" role="tablist">
                        ...
                        <li class="nav-item bg-light">
                            <a class="nav-link" href="#wizard-simple2-step2" data-toggle="tab">Responsables de l'élève</a>
                        </li>
                        <li class="nav-item bg-light">
                            <a class="nav-link" href="#wizard-simple2-step3" data-toggle="tab">Information médicales</a>
                        </li>
                    </ul>
                    <!-- END Step Tabs -->
