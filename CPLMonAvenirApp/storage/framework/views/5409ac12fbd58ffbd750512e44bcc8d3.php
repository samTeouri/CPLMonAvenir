                ...
                <div class="flex-sm-fill">
                    <div class="d-flex justify-content-between">
                        ...
                        <h2 class="font-w700 mb-2">
                            Année Scolaire: <span class="text-primary"><?php echo e($anneeCourante->annee); ?></span>
                        </h2>
                    </div>
                    <h2 class="h6 font-w500 text-muted mb-0">
                        Bienvenue <a class="font-w600" href="javascript:void(0)"><?php echo e(Auth::user()->username); ?></a>, everything
                        looks great.
                    </h2>
                </div>
            </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/CPLMonAvenir/CPLMonAvenirApp/resources/views/index.blade.php ENDPATH**/ ?>