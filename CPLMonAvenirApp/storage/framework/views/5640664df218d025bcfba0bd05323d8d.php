<nav id="sidebar" aria-label="Main Navigation">
    ...
    <div class="content-header bg-white-5">
        <!-- Logo -->
        <a class="font-w600 text-dual" href="<?php echo e(route('dashboard')); ?>">
        ...
        <div class="content-side">
            <ul class="nav-main">
                <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('dashboard')); ?>">
                ...
                <li class="nav-main-item">
                    ...
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="<?php echo e(route('matiere.index')); ?>">
                        ...
                        <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu"
                                    ...
                                    <span class="nav-main-link-name"><?php echo e($promotion->nom); ?>eme</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    ...
                                    <?php $__currentLoopData = $promotion->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <!----- Groupe ---->
                                        <li class="nav-main-item">
                                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu"
                                                aria-haspopup="true" aria-expanded="false" href="#">
                                                <span class="nav-main-link-name"><?php echo e($classe->nom); ?></span>
                                            </a>
                                            <ul class="nav-main-submenu">
                                                <li class="nav-main-item">
                                                    <a class="nav-main-link" href="<?php echo e(route('cours.index', $classe->id)); ?>">
                                ...
                                <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link"
                                            href="<?php echo e(route('evaluation_matieres', $promotion->id)); ?>">
                                            <span class="nav-main-link-name"><?php echo e($promotion->nom); ?>eme</span>
                                        </a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $promotion->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="nav-main-item">
                                                    <a class="nav-main-link nav-main-link-submenu"
                                                        ...
                                                        aria-expanded="false" href="#">
                                                        <span
                                                            class="nav-main-link-name"><?php echo e(substr($classe->nom, 0, 6)); ?></span>
                                                    </a>
                                                    <ul class="nav-main-submenu">
                                                        <li class="nav-main-item">
                                                            <a class="nav-main-link"
                                                                href="<?php echo e(route('interrogation.cours', $classe->id)); ?>">
                        ...
                        <li class="nav-main-item">
                            ...
                            <ul class="nav-main-submenu">
                                <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link"
                                            href="<?php echo e(route('view_evaluation_matieres', $promotion->id)); ?>">
                                            <span class="nav-main-link-name"><?php echo e($promotion->nom); ?>eme</span>
                                        </a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $promotion->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="nav-main-item">
                                                    ...
                                                    <ul class="nav-main-submenu">
                                                        <li class="nav-main-item">
                                                            <a class="nav-main-link"
                                                                href="<?php echo e(route('view_interrogation_cours', $classe->id)); ?>">
                        ...
                        <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="<?php echo e(route('classe.list', $promotion->id)); ?>">
                                    ...
                                    <?php $__currentLoopData = $promotion->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="nav-main-item">
                                            ...
                                            <ul class="nav-main-submenu">
                                                <li class="nav-main-item">
                                                    <a class="nav-main-link"
                                                        href="<?php echo e(route('classe.index', $classe->id)); ?>">
...
<?php /**PATH /var/www/CPLMonAvenir/CPLMonAvenirApp/resources/views/components/sidebar.blade.php ENDPATH**/ ?>